...
Original file is located at
    https://colab.research.google.com/drive/1LWca94mY3WEOmcMuDJh5N4usILug-Dl3
"""
...
# matches played by each team and the number matches won by them
...
# the winning percentage of MI, SRH and RCB
...
# the runs per season. (average and total runs of all the seasons)
...
# distributions of runs over the years which will be distributed among three categories; 6s, 4s and remaining run
...
# we will look at the highest runs scored by teams over the year
